 ...
 */
@Component({
    selector: 'sz-graph-grpc',
    templateUrl: './sz-graph.component.html',
    styleUrls: ['./sz-graph.component.scss'],
    imports: [
      CommonModule,
      SzRelationshipNetworkComponent, SzGraphFilterComponent, SzGraphControlComponent
    ]
})
export class SzGraphComponentGrpc implements OnInit, OnDestroy {
